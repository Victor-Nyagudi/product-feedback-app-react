...
import RoadmapCategory from "../../../../components/pages/roadmap-page/RoadmapCategory";

import * as RoadmapCategoryItemStories from "./RoadmapCategoryItem.stories";

export default {
    title: "App/Pages/Roadmap/RoadmapCategory",
    component: RoadmapCategory,
    args: {
        feedbackItems: [
            {
                "id": 6,
...
const Template = (args) => <RoadmapCategory {...args} />;
...
Live.args = {
    title: "Live",
    color: RoadmapCategoryItemStories.Live.args.color,
    totalItems: 4,
...
Planned.args = {
    title: "Planned",
    color: RoadmapCategoryItemStories.Planned.args.color,
    totalItems: 2,
...
InProgress.args = {
    title: "In Progress",
    color: RoadmapCategoryItemStories.InProgress.args.color,
    totalItems: 3,
    explanation: "Currently being developed"
}

Live.play = RoadmapCategoryItemStories.Live.play;
Planned.play = RoadmapCategoryItemStories.Planned.play;
InProgress.play = RoadmapCategoryItemStories.InProgress.play;